...
import com.zjpl.edw_java.kafka.HandlerProducer;
...
public class CanalHander {
    protected final static Logger logger = LoggerFactory.getLogger(CanalHander.class);
    ...
    private void pringEntry(List<CanalEntry.Entry> entries) {
